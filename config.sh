...
git clone https://github.com/roxma/vim-tmux-clipboard.git ~/.vim/bundle/vim-tmux-clipboard

git clone https://github.com/tmux-plugins/vim-tmux-focus-events.git ~/.vim/bundle/vim-tmux-focus-events.vim
